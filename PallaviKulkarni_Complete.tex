...
\vspace*{2pt}
\begin{innerlist} \item The Model was built on Python using OpenCV and Deepface. OpenCV was used to detect the face and Deepface was used to analyse the facial expression to check what is the current mood of the person. Flask was used to wrap the whole model as a web app.
\end{innerlist}  \vspace*{10pt}
