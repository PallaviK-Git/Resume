...
\lfoot{\hspace{\footpageshift}%
       \parbox{12.7in}{\, \hfill %
                    \begin{flushleft}Pallavi K (Updated Apr 2022) \end{flushleft} \vspace*{-20pt} \hfill{\arabic{page}} 
...
\vspace*{2pt}
\begin{innerlist}
\item Worked on mini projects and implemented various ML models including k-nearest neighbors (KNN), support vector machine (SVM), perceptrons (single and multi-level; SLP and MLP), convolutional neural networks (CNN). 
\item Object classification using CNN on CIFAR's image dataset.
\item Working on digit identification from MNIST dataset using multi-layer-perceptron (MLP). 
\end{innerlist}
\vspace*{8pt}
...
%\vspace*{2pt}
% Akka: Since there is nothing specific and non-obvious, it is alright to include below list
%\begin{innerlist} \item Worked on assignments and mini projects as a part of the course.
%\end{innerlist}  \vspace*{6pt}
