...
\normalsize \email{pkulkarni1@mail.sfsu.edu}  $|$  \emph {\href {https://www.linkedin.com/in/pallavi-kulkarni-aug2009/} {LinkedIn Profile}} $|$ \emph {\href {https://github.com/PallaviK-Git} {Github Profile}}} \\
...
\vspace*{2pt}
\begin{innerlist} \item Working on mini projects on various ML models like KNN, SVN, NN(SLP, MLP), CNN so far. 
